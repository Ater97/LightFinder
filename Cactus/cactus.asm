...
;STATUS REG: BIT0 = CARRY, BIT2 = ZERO

Zero:
MOVF A
DC, W
SUBLW B'00011011'
MOVF B'11111100', D_BCD
BTFSC STATUS, 0
BTFSC STATUS, 2
GOTO SET_BCD
GOTO ONE
...
MOVWF PORTB
;********************************
GOTO DONDESEAQUEHAYAQUELLAMARLO;*
;********************************
